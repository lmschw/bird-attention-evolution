...
NAME = "Wolf"
AVERAGE_SPEED = 15.3 # m/s
AVERAGE_SPEED = 0.153 # m/s
#AVERAGE_SPEED = 0.01
...
FOVEAL_REGION_AZIMUTH_HORIZONTAL = np.deg2rad(12.5)
FOVEAL_REGION_FIELD_HORIZONTAL_HALF = np.deg2rad(100)
FOVEAL_REGION_AZIMUTH_VERTICAL = np.deg2rad(0)
FOVEAL_REGION_FIELD_VERTICAL_HALF = np.deg2rad(2)
FOVEAL_REGION_COMFORTABLE_DISTANCE = (0, 45)
FOVEAL_REGION_FOVEAL_ANGLE = np.deg2rad(40)
