...
FOVEAL_REGION_AZIMUTH_HORIZONTAL = np.deg2rad(80)
...
FOVEAL_REGION_COMFORTABLE_DISTANCE = (0, SENSING_RANGE)
FOVEAL_REGION_FOVEAL_ANGLE = np.deg2rad(10)
