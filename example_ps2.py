...
path_options = [np.array([to_my_left, 0, to_my_left, 0, 0, to_my_right]),
                np.array([to_my_right, 0, to_my_left, 0, 0, 0]),
                np.array([to_my_left, to_my_right, 0, 0, 0, to_my_left]),
                np.array([to_my_left, 0, to_my_left, 0, to_my_left, 0]),
                np.array([0, 0, to_my_left, 0, 0, to_my_right]),
                np.array([to_my_right, 0, 0, to_my_left, to_my_left, 0]),
                np.array([to_my_right, 0, 0, to_my_left, 0, 0])]
