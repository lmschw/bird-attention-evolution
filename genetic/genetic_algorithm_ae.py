...
"""
Implements Differential Evolution for the Active Elastic implementation evolving the head movement via a neural network.
"""

class DifferentialEvolution:
    def __init__(self, tmax, num_agents, animal_type=Pigeon(), domain_size=(50,50), weight_options=[],
