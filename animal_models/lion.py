...
NAME = "Lion"
AVERAGE_SPEED = 22.2 # m/s
AVERAGE_SPEED = 0.222 # m/s
#AVERAGE_SPEED = 0.01
...
LENGTH = 1.6 # meters
HEIGHT = 1.2 # meters
HEAD_RANGE_HALF = np.deg2rad(120) # WARNING: THIS IS AN ASSUMPTION
MAX_TURN_ANGLE = np.deg2rad(180) # WARNING: THIS IS AN ASSUMPTION
...
FOVEAL_REGION_AZIMUTH_HORIZONTAL = np.deg2rad(50)
...
FOVEAL_REGION_FOVEAL_ANGLE = np.deg2rad(50)
